  ...
  return (
    <div className="main-content">
          ...
          <div style={{ display: 'flex', gap: '0.5rem', backgroundColor: '#f3f4f6', padding: '0.25rem', borderRadius: '0.5rem' }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '0.375rem',
                border: 'none',
                backgroundColor: viewMode === 'combined' ? '#3b82f6' : 'transparent',
                color: viewMode === 'combined' ? 'white' : '#374151',
                cursor: 'pointer',
                fontSize: '0.875rem',
                fontWeight: viewMode === 'combined' ? '600' : '400',
              }}
            >
              Combined
            </button>
      ...
      <div style={{ marginTop: '1.5rem' }}>
        {/* Combined View - List and Map Side by Side */}
        {viewMode === 'combined' && (
          <div style={{ 
            display: 'flex',
            gap: '1.5rem',
                  ...
                  <div>
                    {filteredProperties.map((property) => (
                      <div 
                        ...
                        style={{
                          cursor: 'pointer',
                          border: selectedProperty === property.id ? '2px solid #3b82f6' : undefined,
                          marginBottom: '1rem',
                        }}
        ...
        {/* List View or Both View (Stacked) */}
        ...
        {/* Map View - Show when map or both view is selected (not combined) */}
